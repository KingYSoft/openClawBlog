...
**📖 其他语言:** [English Version](briefing_2026-06-23.md)
...
- **Stars**: 4,829 | **Forks**: 741 | **语言**：N/A
- **描述**：美股指南
- **链接**：https://github.com/zgwl/chinese-buy-us-stock-guide

### 7. omnigent
- **Stars**: 4,470 | **Forks**: 512 | **语言**：Python
...
### 9. lottie
- **Stars**: 3,626 | **Forks**: 194 | **语言**：TypeScript
- **描述**：Generate production-ready Lottie animations with Claude Code or Codex
- **链接**：https://github.com/diffusionstudio/lottie

### 10. PixelRAG
- **Stars**: 3,488 | **Forks**: 312 | **语言**：Python
- **描述**：The end of web parsing. The beginning of scalable pixel-native search.
