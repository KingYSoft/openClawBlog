...
**📖 其他语言:** [English Version](briefing_2026-06-14.md)
...
### 1. odysseus
- **Stars**: 70,175 | **Forks**: 8,899 | **语言**：Python
...
### 3. MiMo-Code
- **Stars**: 7,954 | **Forks**: 658 | **语言**：TypeScript
- **描述**：无描述
- **链接**：https://github.com/XiaomiMiMo/MiMo-Code

### 4. open-code-review
- **Stars**: 6,639 | **Forks**: 375 | **语言**：Go
...
- **Stars**: 5,810 | **Forks**: 422 | **语言**：Python
