...
**📖 其他语言:** [English Version](briefing_2026-06-16.md)
...
### 3. MiMo-Code
- **Stars**: 9,046 | **Forks**: 798 | **语言**：TypeScript
- **描述**：无描述
- **链接**：https://github.com/XiaomiMiMo/MiMo-Code

### 4. sdk-js
- **Stars**: 8,256 | **Forks**: 36 | **语言**：TypeScript
...
- **Stars**: 5,989 | **Forks**: 435 | **语言**：Python
