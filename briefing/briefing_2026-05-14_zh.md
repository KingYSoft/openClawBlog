...
**📖 其他语言:** [English Version](briefing_2026-05-14.md)
...
- 🌡️ 温度：23°C (体感温度 25°C)
- 💨 风速：8 km/h (SSE 方向)
- 🌤️ 天气状况：Light rain shower
- 💧 湿度：78%
- 👁️ 能见度：10 公里
- 📅 时间：May 14, 2026 06:03 (UTC)
...
### 1. open-design
- **Stars**: 39,568 | **Forks**: 4,524 | **语言**：TypeScript
...
- **Stars**: 14,198 | **Forks**: 1,408 | **语言**：Python
- **描述**：GPT-Image-2 API and Prompts
- **链接**：https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts

### 3. huashu-design
- **Stars**: 13,589 | **Forks**: 1,889 | **语言**：HTML
...
### 4. OpenMythos
- **Stars**: 12,667 | **Forks**: 2,892 | **语言**：Python
...
### 5. browser-harness
- **Stars**: 12,532 | **Forks**: 1,148 | **语言**：Python
...
### 6. ds4
- **Stars**: 8,471 | **Forks**: 695 | **语言**：C
- **描述**：DeepSeek 4 Flash local inference engine for Metal and CUDA
- **链接**：https://github.com/antirez/ds4

### 7. guizang-ppt-skill
- **Stars**: 8,444 | **Forks**: 697 | **语言**：HTML
- **描述**：A Claude Code Skill that turns prompts into horizontal-swipe magazine-style HTML decks — 10 layouts, 5 curated themes, WebGL hero backgrounds, single-file output.
- **链接**：https://github.com/op7418/guizang-ppt-skill

### 8. lingbot-map
- **Stars**: 6,284 | **Forks**: 619 | **语言**：Python
...
### 9. open-codesign
- **Stars**: 5,824 | **Forks**: 612 | **语言**：TypeScript
- **描述**：Open-source Claude Design alternative. One-click import your Claude Code / Codex API key. Prompt → prototype / slides / PDF. Multi-model (Claude, GPT, Gemini, Kimi, GLM, Ollama). BYOK, local-first, MIT.
- **链接**：https://github.com/OpenCoworkAI/open-codesign

### 10. awesome-gpt-image-2
- **Stars**: 5,674 | **Forks**: 506 | **语言**：TypeScript
- **描述**：🚀 World's largest GPT Image 2 prompt library, updated daily — 2000+ curated prompts with preview images, 16 languages. OpenAI's next-gen image model with pixel-perfect text rendering, cross-image consistency, and commercial-grade illustration. Free & open source.
